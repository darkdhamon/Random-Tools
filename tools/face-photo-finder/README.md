...
- includes Timeline and Identity web tabs with searchable identity statistics, biometric reference-image thumbnails and an in-app viewer, inline name/birth-year editing, and person-filtered timeline navigation;
